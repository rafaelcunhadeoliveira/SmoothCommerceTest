...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SmoothCommerceTest",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18SmoothCommerceTest11AppDelegate")
...
SWIFT_CLASS("_TtC18SmoothCommerceTest17FeedTableViewCell")
@interface FeedTableViewCell : UITableViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified userImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified nameLabel;
- (void)awakeFromNib;
- (IBAction)urlButtonPressed:(id _Nonnull)sender;
- (IBAction)videoButtonPressed:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC18SmoothCommerceTest18HomeViewController")
...
@interface HomeViewController (SWIFT_EXTENSION(SmoothCommerceTest)) <UITableViewDataSource>
...
SWIFT_CLASS("_TtC18SmoothCommerceTest13SceneDelegate")
...
SWIFT_CLASS("_TtC18SmoothCommerceTest21WebPageViewController")
...
@interface WebPageViewController (SWIFT_EXTENSION(SmoothCommerceTest)) <WKNavigationDelegate>
